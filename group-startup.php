...
<html>
	...
	<body>
		...
		<div class = "main">
			<h1 align = "center">[Start-up Group]</h1>
			<h3 align = "center">Hey, do you want money? Type question now...</h3><br><br>
			<?php 
				...
				if (!isset($_POST['action']) || $_POST['action']==""){
					...
					if ($messages != ""){
						$sql= " INSERT INTO startup (user, message) VALUES ('$user','$messages')";
			...
			?>
				...
				<div class = "messchat">
				<?php
					$display = mysqli_query($con, "SELECT * from startup ORDER BY time DESC");
				...
				?>
					...
					<form action ="group-startup.php" method ="POST">
					<br>
