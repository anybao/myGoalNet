...
<html>
	...
	<body>
		...
		<div class = "main">
			<h1 align = "center">[Free Group]</h1>
			<h3 align = "center">Let the world know your feeling...</h3><br><br>
			<?php 
				...
				if (!isset($_POST['action']) || $_POST['action']==""){
					...
					if ($messages != ""){
						$sql= " INSERT INTO messages (user, message) VALUES ('$user','$messages')";
			...
			?>
				<div class="messchat">
				<?php
					$display = mysqli_query($con, "SELECT * from messages ORDER BY time DESC");
				...
				<form action ="group-free.php" method ="POST">
				<br>
